...
export default function (): PrideColor[] {
	...
	return [
		...
		{ name: "Cenrell", colors: ["#929df9", "#a0dbfb", "#ffffff", "#c9f79f", "#95d79a"] },
		{ name: "Demiboy", colors: ["#7b7b7b", "#c3c3c3", "#99d9ea", "#ffffff", "#99d9ea", "#c3c3c3", "#7b7b7b"] },
		{ name: "Demigender", colors: ["#7b7b7b", "#c3c3c3", "#f8fd73", "#ffffff", "#f8fd73", "#c3c3c3", "#7b7b7b"] },
